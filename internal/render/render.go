...
// headersFile is the Cloudflare Pages _headers file. It mirrors the
...
# Self-hosted font: stable filename, but it effectively never changes.
/fonts/*
  Cache-Control: public, max-age=31536000, immutable
...
# Everything else is HTML: short TTL so edits go live quickly.
/*
  Cache-Control: public, max-age=60
`

// writeHeadersFile writes the _headers file into the build output. Pages reads
// it from the output directory root and does not serve it.
